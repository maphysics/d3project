...
public class Tmain {
    public static void main(String[] args){
        TransformCSV transform = new TransformCSV("C:\\wamp\\www\\d3project\\src\\com\\maphysics\\resources\\exercisedata2.csv",
                "C:\\wamp\\www\\d3project\\src\\com\\maphysics\\resources\\exercisedataFormated.csv");
        try {
            transform.load();
        } catch (Exception e){
